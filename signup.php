...
<body>
        ...
        <div class="signup-form">
            ...
            <div class="form-bottom">
                <form action="register.php" method="POST">
                    ...
                    <span class="pswd_icon_bg" onclick="reg_pswd_toggle()"><i class="fa-regular fa-eye" id="reg_pswd_show" style="margin: auto;"></i></span>
                    <input type="password" id="register_pswd" name="reg_password" placeholder="Password" required>

                    <!-- Confirm Password -->
                     <label>Confirm password</label>
                    <span class="pswd_icon_bg" onclick="reg_conf_pswd_toggle()"><i class="fa-regular fa-eye" id="reg_conf_pswd_show" style="margin: auto;"></i></span>
                    <input type="password" id="register_confirm_pswd" name="reg_password2" placeholder="Confirm Password" required>

                    <!-- Error Messages -->
                    <?php
                    if (in_array("Your passwords don't match", $error_array)) echo "<p class='alert'>Your passwords don't match</p>";
                    ...
                    <!-- PHP Validation (Assuming you have a function for password validation) -->
                    <?php
                    function validatePassword($password) {
                    // Your custom password validation logic goes here
                    // Example validation: Password must be between 5 and 30 characters
                    return (strlen($password) >= 5 && strlen($password) <= 30);
                    }
                    ...
                    $confirmPassword = $_POST['reg_password2'];
                     ...
                     // Validate the password length using the function
                    if (!validatePassword($password)) {
                        $error_array[] = "Your password must be between 5 and 30 characters or numbers";
                    }

                     // Check if passwords match
                    if ($password !== $confirmPassword) {
                         $error_array[] = "Your passwords don't match";
                         }
    ...
    <footer>			
    	<div class="footer"> 
    		...
    		<p> ©2020 All Rights Reserved <BR> Website designed and developed by <strong><U>UIU updates team</u></strong></p>
    	</div>
    </footer>
